...
function ejercicio5() {
	...
	var tama = parseInt(prompt("Ingresa el tamanio del arreglo del cuadro magico (nxn)"));
	var cuadrado = new Array(tama), numeros = new Array(Math.pow(tama, 2));
	b = 0;
	for (var i = 0; i < tama; i++) {
		cuadrado[i] = new Array(tama);
